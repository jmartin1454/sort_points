...
for y in arange(body_spacing/2,a_out/2,body_spacing):
    if(y<a_in/2):
        point1=(a_in/2,y,a_out/2)
        point2=(-a_in/2,y,a_out/2)
        point3=(-a_in/2,y,-a_out/2)
        point4=(a_in/2,y,-a_out/2)
    else:
        xpos=a_in/2-(y-a_in/2)/(a_out/2-a_in/2)*a_in/2
        point1=(xpos,y,a_out/2)
        point2=(-xpos,y,a_out/2)
        point3=(-xpos,y,-a_out/2)
        point4=(xpos,y,-a_out/2)
...
sidetop_spacing=current*(a_out-a_in)/a_in

side_coil=coilset()
for y in arange(sidetop_spacing/2,a_out/2,sidetop_spacing):
    print(y)
    if(y<a_in/2):
        point1=(a_in/2,y,a_out/2)
        point2=(a_out/2,y,a_out/2)
        point3=(a_out/2,y,-a_out/2)
        point4=(a_in/2,y,-a_out/2)
    else:
        xpos=y
        point1=(xpos,y,a_out/2)
...
for x in arange(sidetop_spacing/2,a_out/2,sidetop_spacing):
    if(x<a_in/2):
        ypos=a_in/2-(x-a_in/2)/(a_in/2)*(a_out/2-a_in/2)
    else:
        ypos=x
    point1=(x,a_out/2,a_out/2)
    point2=(x,a_out/2,-a_out/2)
    point3=(x,ypos,-a_out/2)
    point4=(x,ypos,a_out/2)
    points=np.array((point1,point2,point3,point4))
